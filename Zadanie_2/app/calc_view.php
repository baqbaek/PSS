<?php
// Tu nie ładujemy już konfiguracji, ponieważ sam widok nie jest już punktem wejścia do aplikacji.
...
<?php if (isset($result)) { ?>
<div style="margin-top: 1em; padding: 1em; border-radius: 0.5em; background-color: #f0f; width:15em;">
<?= 'Miesięczna rata wynosi: ' . round($result, 2) . "zł"; ?>
</div>
<?php } ?>
